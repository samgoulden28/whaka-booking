...
const auth = google.auth.getClient({
  ...
  credentials: {
    ...
    private_key: process.env.GSHEETS_PRIVATE_KEY || process.env.GSHEETS_PRIVATE_KEY_BASE64 ? Buffer.from(process.env.GSHEETS_PRIVATE_KEY_BASE64 || "", "base64").toString("ascii") : "",
